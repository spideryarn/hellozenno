...
export const ROUTES = {
  ...
  SOURCEDIR_API_CREATE_SOURCEDIR_API: "/api/lang/sourcedir/api/sourcedir/{target_language_code}",
  SOURCEDIR_API_DELETE_SOURCEDIR_API: "/api/lang/sourcedir/api/sourcedir/{target_language_code}/{sourcedir_slug}",
  SOURCEDIR_API_UPDATE_SOURCEDIR_LANGUAGE_API: "/api/lang/sourcedir/api/sourcedir/{target_language_code}/{sourcedir_slug}/language",
  SOURCEDIR_API_RENAME_SOURCEDIR_API: "/api/lang/sourcedir/api/sourcedir/{target_language_code}/{sourcedir_slug}/rename",
  SOURCEDIR_API_UPLOAD_SOURCEDIR_NEW_SOURCEFILE_API: "/api/lang/sourcedir/api/sourcedir/{target_language_code}/{sourcedir_slug}/upload",
