<script lang="ts">
  ...
  onMount(async () => {
    if (page.params.target_language_code) {
      try {
        languageName = await get_language_name(page.params.target_language_code);
      } catch (e) {
        languageName = page.params.target_language_code.toUpperCase();
      }
    }
  });
</script>
...
<div class="row justify-content-center mt-5">
  <div class="col-md-8">
    <div class="card bg-dark text-white border-danger">
      ...
      <div class="card-body">
        <p class="lead">Sorry, something went wrong while accessing {languageName || page.params.target_language_code?.toUpperCase() || 'language'} content.</p>
        ...
        <ul class="list-unstyled">
          ...
          {#if page.params.target_language_code}
            <li>
              <a href="/language/{page.params.target_language_code}/sources" class="btn btn-info">
                <i class="ph ph-arrow-left me-2"></i>Back to {languageName || page.params.target_language_code.toUpperCase()} language page
              </a>
            </li>
          {/if}
        </ul>
