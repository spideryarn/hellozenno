...
export { default as LemmaAudioButton } from "./components/LemmaAudioButton.svelte";
export { default as SentenceAudioButton } from "./components/SentenceAudioButton.svelte";
