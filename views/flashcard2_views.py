"""
New Svelte-based flashcard system for language learning.
...
def flashcard2_landing(language_code: str):
...
def flashcard2_sentence(language_code: str, slug: str):
...
def random_flashcard2(language_code: str):
    ...
    return redirect(
        url_for(
            "flashcard2_views.flashcard2_sentence",
...
def api_flashcard2_sentence(language_code: str, slug: str):
...
def api_random_flashcard2(language_code: str):
